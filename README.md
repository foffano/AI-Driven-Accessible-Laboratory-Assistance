...
This part contains the code and data for evaluating the multimodal LLM against a controlled set of images.

- `part_one/adc.py`: The main script for the evaluation.
- `part_one/dataset/`: The controlled image dataset.
